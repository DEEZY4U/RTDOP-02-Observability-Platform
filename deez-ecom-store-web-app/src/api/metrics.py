"""
Prometheus Metrics for Deez Ecom Store API
...
ecom_operations_total = Counter(
    name='deez_ecom_operations_total', 
...
http_request_duration_seconds = Histogram(
    name='deez_http_request_duration_seconds',
...
order_processing_duration_seconds = Histogram(
    name='deez_order_processing_duration_seconds',
...
database_operation_duration_seconds = Histogram(
    name='deez_database_operation_duration_seconds',
...
application_errors_total = Counter(
    name='deez_application_errors_total',
...
database_errors_total = Counter(
    name='deez_database_errors_total',
...
active_connections = Gauge(
    name='deez_active_connections_current',
...
task_queue_size = Gauge(
    name='deez_task_queue_size_current',
...
ecom_inventory_total = Gauge(
    name='deez_ecom_inventory_total',
...
customers_active_total = Gauge(
    name='deez_customers_active_total',
