...
LOG_ENTRY=$(docker logs deez-ecom-store-api 2>&1 | grep "order_id.*$ORDER_ID" | tail -1)
...
echo "   🔍 Search for service: deez-ecom-store-api"
...
echo "   📊 Navigate to: 'Deez Ecom Store - End-to-End Purchase Journey' dashboard"
